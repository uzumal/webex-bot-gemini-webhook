function doPost(e) {
    ...
    const WEBEX_ACCESS_TOKEN = scriptProperties.getProperty('WEBEX_ACCESS_TOKEN');
    const GEMINI_APIKEY = scriptProperties.getProperty('GEMINI_APIKEY');
    const MY_BOT_NAME = scriptProperties.getProperty('MY_BOT_NAME');
